    ...
    <>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>
          Спокій <span className={styles.gradientText}>у темряві:</span> Ваш план
        </h1>
        <p className={styles.subtitle}>
          Коли немає світла, стабільності й відчуття безпеки — але потрібно жити далі
        </p>
        <section className={styles.collage}>
          <div className={styles.collageItem}>
            <Image 
              src="/main_collage/1.jpg" 
              alt="Колаж 1" 
              fill
              style={{ objectFit: 'cover' }}
            />
          </div>
          <div className={`${styles.collageItem} ${styles.collageItemMiddle}`}>
            <Image 
              src="/main_collage/2.jpg" 
              alt="Колаж 2" 
              fill
              style={{ objectFit: 'cover' }}
            />
